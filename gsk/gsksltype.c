...
static const char *
gsk_sl_type_block_get_name (GskSlType *type)
{
  GskSlTypeBlock *block = (GskSlTypeBlock *) type;
...
static GskSlScalarType
gsk_sl_type_block_get_scalar_type (GskSlType *type)
{
  return GSK_SL_VOID;
}

static GskSlType *
gsk_sl_type_block_get_index_type (GskSlType *type)
{
  return NULL;
}

static gsize
gsk_sl_type_block_get_index_stride (GskSlType *type)
{
  return 0;
}

static guint
gsk_sl_type_block_get_length (GskSlType *type)
{
  return 0;
}

static gsize
gsk_sl_type_block_get_size (GskSlType *type)
{
  GskSlTypeBlock *block = (GskSlTypeBlock *) type;
...
static const GskSlTypeMember *
gsk_sl_type_block_get_member (GskSlType *type,
                              guint      n)
{
  GskSlTypeBlock *block = (GskSlTypeBlock *) type;
...
static gboolean
gsk_sl_type_block_can_convert (GskSlType *target,
                               GskSlType *source)
{
  return gsk_sl_type_equal (target, source);
}
...
static guint32
gsk_sl_type_block_write_spv (const GskSlType *type,
                             GskSpvWriter    *writer)
{
  GskSlTypeBlock *block = (GskSlTypeBlock *) type;
